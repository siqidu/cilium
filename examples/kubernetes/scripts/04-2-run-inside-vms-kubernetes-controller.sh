...
wget https://raw.githubusercontent.com/cilium/cilium/changing-k8s-installation/examples/kubernetes/deployments/token.csv

sudo mv token.csv /var/lib/kubernetes/

wget https://raw.githubusercontent.com/cilium/cilium/changing-k8s-installation/examples/kubernetes/deployments/authorization-policy.jsonl
